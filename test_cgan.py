...
data_loader = torch.utils.data.DataLoader(train_dataset, batch_size=len(train_dataset))
...
train_loader = DataLoader(data_train, batch_size=opt.batch_size, drop_last=True)
test_loader = DataLoader(data_test, batch_size=opt.batch_size, drop_last=True)
